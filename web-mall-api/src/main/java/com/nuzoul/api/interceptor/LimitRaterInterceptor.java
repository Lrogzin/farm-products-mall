package com.nuzoul.api.interceptor;

import cn.hutool.core.util.StrUtil;
import com.nuzoul.api.limit.RedisRaterLimiter;
import com.nuzoul.common.anotation.RateLimiter;
import com.nuzoul.common.constant.CommonConstant;
import com.nuzoul.common.exception.FPMallException;
import com.nuzoul.common.utils.IPInfoUtil;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if (rateLimiter != null) {
            ...
            if (StrUtil.isBlank(token3)) {
                throw new FPMallException("当前访问人数太多啦，请稍后再试");
            }
        }
        return true;
    }
