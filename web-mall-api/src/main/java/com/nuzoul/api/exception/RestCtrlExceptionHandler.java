package com.nuzoul.api.exception;
...
public class RestCtrlExceptionHandler {
    ...
    @ResponseStatus(value = HttpStatus.OK)
    @ExceptionHandler(FPMallException.class)
    @ResponseBody
    public Result<Object> handleFPMallException(FPMallException e) {
    ...
    public Result<Object> handleException(Exception e) {
        ...
        if (e!=null){
            ...
            } else if(e.getMessage().contains("FPMallException")){
                errorMsg = e.getMessage();
                errorMsg = StringUtils.substringAfter(errorMsg,"FPMallException:");
