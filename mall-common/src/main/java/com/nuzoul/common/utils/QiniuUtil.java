package com.nuzoul.common.utils;

import com.google.gson.Gson;
import com.nuzoul.common.exception.FPMallUploadException;
...
public class QiniuUtil {
     ...
     * 生成上传凭证，然后准备上传
     */
    private static String accessKey = "yCgFi6Bz95ulmsP8FqPSTNLHxFTPIW9lo6hJjt";
    private static String secretKey = "nhyQnx5tKieMEyvSgqxxo1WCgMcVUt9UuTEKvxrN";
    private static String bucket = "fpmall";
    private static String origin="pnh3tt0mw.bkt.clouddn.com";
    ...
    public static String qiniuUpload(String filePath){
        ...
        try {
            ...
            try {
                ...
                throw new FPMallUploadException(e.toString());
            }
        }
    }
