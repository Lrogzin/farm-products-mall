package com.nuzoul.es.service.impl;

import com.google.gson.Gson;
import com.nuzoul.common.exception.FPMallException;
import com.nuzoul.common.utils.HttpUtil;
import com.nuzoul.dto.EsCount;
import com.nuzoul.dto.EsInfo;
import com.nuzoul.dto.front.SearchItem;
import com.nuzoul.es.service.SearchItemService;
...
public class SearchItemServiceImpl implements SearchItemService {
	...
	public int importAllItems() {
		...
		try{
			...
			e.printStackTrace();
			throw new FPMallException("导入ES索引库出错，请再次尝试");
		}
	...
	public EsInfo getEsInfo() {
		...
		if(StringUtils.isBlank(healthResult)|| StringUtils.isBlank(countResult)){
			throw new FPMallException("连接集群失败，请检查ES运行状态");
		}
		...
		try {
			...
			e.printStackTrace();
			throw new FPMallException("获取ES信息出错");
		}
